...
class KMeansTestCluster():
    ...
    def plot(self, WSS,SWCD, cIDx,V_measure, silhouette, BSS_TSS):
            ...
            plt.grid(True)
            plt.xlim(2,20)
            plt.text(9, 0.55, 'Digits', style='italic',bbox={'facecolor':'yellow', 'alpha':0.5, 'pad':2})
            plt.savefig('/Users/jacquelineroudes/Documents/GTL_courses/Machine_Learning/Homework3/images/digits/BSS_TSS.png')
            plt.show()
            ...
            plt.text(9, 18500, 'Digits', style='italic',bbox={'facecolor':'yellow', 'alpha':0.5, 'pad':2})
            plt.savefig('/Users/jacquelineroudes/Documents/GTL_courses/Machine_Learning/Homework3/images/digits/WSS_SWCD.png')
