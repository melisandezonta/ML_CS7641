...
plt.text(6, 0.48, 'Breast Cancer', style='italic',
        bbox={'facecolor':'yellow', 'alpha':0.5, 'pad':2})
plt.grid(True)
plt.savefig('/Users/jacquelineroudes/Documents/GTL_courses/Machine_Learning/Homework3/images/digits/ica_silhouette_EM_Kmeans.png')
plt.show()  
...
plt.text(6, 0.48, 'Breast Cancer', style='italic',
        bbox={'facecolor':'yellow', 'alpha':0.5, 'pad':2})
plt.grid(True)
plt.savefig('/Users/jacquelineroudes/Documents/GTL_courses/Machine_Learning/Homework3/images/digits/ica_V_measure_EM_Kmeans.png')
plt.show()
...
sample_size = 300
reduced_data = decomposition.FastICA(n_components = 3, whiten=True).fit_transform(data)
kmeans = KMeans(init='k-means++', n_clusters= n_classes, n_init=50)
