...
with plt.style.context('seaborn-whitegrid'):
    ...
    for lab, col in zip(np.arange(0,10), 
        ...
        plt.savefig('/Users/jacquelineroudes/Documents/GTL_courses/Machine_Learning/Homework3/images/digits/rp_3D.png')
    plt.tight_layout()
plt.show()
plt.clf()
...
plt.ylim(0.500,0.990)
plt.grid(True)
plt.savefig('/Users/jacquelineroudes/Documents/GTL_courses/Machine_Learning/Homework3/images/digits/rp_accuracy.png')
