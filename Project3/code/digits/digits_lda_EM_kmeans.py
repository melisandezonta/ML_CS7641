...
plt.text(6, 0.39, 'Breast Cancer', style='italic',
        bbox={'facecolor':'yellow', 'alpha':0.5, 'pad':2})
plt.grid(True)
plt.xlim(2,20)
plt.savefig('/Users/jacquelineroudes/Documents/GTL_courses/Machine_Learning/Homework3/images/digits/lda_silhouette_EM_Kmeans.png')
plt.show()  
...
plt.legend(bbox_to_anchor=(0.76, 0.99), loc=2, borderaxespad=0.)
plt.text(6, 0.92, 'Breast Cancer', style='italic',
        bbox={'facecolor':'yellow', 'alpha':0.5, 'pad':2})
plt.grid(True)
plt.xlim(2,20)
plt.savefig('/Users/jacquelineroudes/Documents/GTL_courses/Machine_Learning/Homework3/images/digits/lda_V_measure_EM_Kmeans.png')
plt.show()
...
lda3=discriminant_analysis.LinearDiscriminantAnalysis(solver='svd', shrinkage=None, priors=None, n_components=3, store_covariance=False, tol=0.0001)

reduced_data = lda3.fit_transform(data,labels)
kmeans = KMeans(init='k-means++', n_clusters= n_classes, n_init=50)
...
# je crois que c'est pas possible de plotter les clusters en 3D avec EM ... Mais je sais pas, tu pourras essayer
...
#
#sample_size = 300
#lda3=discriminant_analysis.LinearDiscriminantAnalysis(solver='svd', shrinkage=None, priors=None, n_components=None, store_covariance=False, tol=0.0001)
#
#reduced_data = lda3.fit_transform(data,labels)
#model = mixture.GaussianMixture(n_components=10, max_iter= 5000, n_init=50, init_params='kmeans')
