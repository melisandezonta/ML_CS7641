...
class ExpectationMaximizationTestCluster():
    ...
    def run(self):
        ...
        for k in self.clusters:
                model = mixture.GaussianMixture(n_components=k, max_iter= 5000, n_init=100, init_params='kmeans')
    ...
    def plot(self,vmeasure_scores, log_likelihood, silhouette, bic):
        ...
        """
        plt.plot(self.clusters, vmeasure_scores, 'b.-')
        ...
        plt.grid(True)
        plt.text(6, 10000, 'Breast Cancer', style='italic',
        bbox={'facecolor':'yellow', 'alpha':0.5, 'pad':2})
        plt.savefig('/Users/jacquelineroudes/Documents/GTL_courses/Machine_Learning/Homework3/images/breast_cancer/log_likelihood_BIC.png')
        plt.show()
