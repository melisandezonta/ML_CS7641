...
with plt.style.context('seaborn-whitegrid'):
    ...
    plt.bar(range(X.shape[1]), var_exp, alpha=0.5, align='center',
...
with plt.style.context('seaborn-whitegrid'):
    ...
    plt.legend(loc='best')
    plt.tight_layout()
    plt.savefig('/Users/jacquelineroudes/Documents/GTL_courses/Machine_Learning/Homework3/images/breast_cancer/pca_eigen_values.png')
...
#                     c=col)
        ...
        plt.tight_layout()
        plt.savefig('/Users/jacquelineroudes/Documents/GTL_courses/Machine_Learning/Homework3/images/breast_cancer/pca_3D.png')
    plt.show()
...
plt.ylim(0.950,0.990)
plt.grid(True)
plt.savefig('/Users/jacquelineroudes/Documents/GTL_courses/Machine_Learning/Homework3/images/breast_cancer/pca_accuracy.png')
