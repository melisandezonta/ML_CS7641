...
svm = SVC(C=1.0, kernel='linear', degree=3, gamma='auto', 
          ...
          class_weight=None, verbose=False, max_iter=20000, decision_function_shape=None, 
          random_state=None)
...
for repetition in range(100):
    ...
    svm = SVC(max_iter = 20000)# increase the default max_iter
...
plt.figure()
cv_scores = cross_val_score(svm, arr_in, arr_out, cv=10)
