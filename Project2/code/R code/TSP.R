...
df.rhc = read_csv("./OptimizationResults/tspRHC.csv")
...
df.sa = read.csv("./OptimizationResults/TSPSA_IT1.0E12_CF0.95.csv")
...
df.ga = read.csv("./OptimizationResults/tspGA_POP500_MAT100_MUT40.csv")
...
#TSP Problem MIMIC
df.mimic = read.csv("./OptimizationResults/tspMIMIC_SAM200_KEP100.csv")
